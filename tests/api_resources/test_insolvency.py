...
from openregister.types import InsolvencyGetDetailsV1Response
...
class TestInsolvency:
    ...
    def test_method_get_details_v1(self, client: Openregister) -> None:
        insolvency = client.insolvency.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(InsolvencyGetDetailsV1Response, insolvency, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get_details_v1(self, client: Openregister) -> None:
        response = client.insolvency.with_raw_response.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    def test_streaming_response_get_details_v1(self, client: Openregister) -> None:
        with client.insolvency.with_streaming_response.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
    ...
    def test_path_params_get_details_v1(self, client: Openregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `insolvency_id` but received ''"):
            client.insolvency.with_raw_response.get_details_v1(
                "",
            )
...
class TestAsyncInsolvency:
    ...
    async def test_method_get_details_v1(self, async_client: AsyncOpenregister) -> None:
        insolvency = await async_client.insolvency.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
        assert_matches_type(InsolvencyGetDetailsV1Response, insolvency, path=["response"])
    ...
    async def test_raw_response_get_details_v1(self, async_client: AsyncOpenregister) -> None:
        response = await async_client.insolvency.with_raw_response.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        )
    ...
    async def test_streaming_response_get_details_v1(self, async_client: AsyncOpenregister) -> None:
        async with async_client.insolvency.with_streaming_response.get_details_v1(
            "182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_get_details_v1(self, async_client: AsyncOpenregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `insolvency_id` but received ''"):
            await async_client.insolvency.with_raw_response.get_details_v1(
                "",
            )

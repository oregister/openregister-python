...
class TestCompany:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_get_ubos_v1(self, client: Openregister) -> None:
        company = client.company.get_ubos_v1(
            "company_id",
        )
        assert_matches_type(CompanyGetUbosV1Response, company, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_get_ubos_v1(self, client: Openregister) -> None:
        response = client.company.with_raw_response.get_ubos_v1(
            "company_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_get_ubos_v1(self, client: Openregister) -> None:
        with client.company.with_streaming_response.get_ubos_v1(
            "company_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_get_ubos_v1(self, client: Openregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            client.company.with_raw_response.get_ubos_v1(
                "",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_method_retrieve_shareholders(self, client: Openregister) -> None:
        company = client.company.retrieve_shareholders(
            "company_id",
        )
        assert_matches_type(CompanyRetrieveShareholdersResponse, company, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve_shareholders(self, client: Openregister) -> None:
        response = client.company.with_raw_response.retrieve_shareholders(
            "company_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_shareholders(self, client: Openregister) -> None:
        with client.company.with_streaming_response.retrieve_shareholders(
            "company_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_path_params_retrieve_shareholders(self, client: Openregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            client.company.with_raw_response.retrieve_shareholders(
                "",
            )
...
class TestAsyncCompany:
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_get_ubos_v1(self, async_client: AsyncOpenregister) -> None:
        company = await async_client.company.get_ubos_v1(
            "company_id",
        )
        assert_matches_type(CompanyGetUbosV1Response, company, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_get_ubos_v1(self, async_client: AsyncOpenregister) -> None:
        response = await async_client.company.with_raw_response.get_ubos_v1(
            "company_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_get_ubos_v1(self, async_client: AsyncOpenregister) -> None:
        async with async_client.company.with_streaming_response.get_ubos_v1(
            "company_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_get_ubos_v1(self, async_client: AsyncOpenregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            await async_client.company.with_raw_response.get_ubos_v1(
                "",
            )

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_method_retrieve_shareholders(self, async_client: AsyncOpenregister) -> None:
        company = await async_client.company.retrieve_shareholders(
            "company_id",
        )
        assert_matches_type(CompanyRetrieveShareholdersResponse, company, path=["response"])
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_shareholders(self, async_client: AsyncOpenregister) -> None:
        response = await async_client.company.with_raw_response.retrieve_shareholders(
            "company_id",
        )
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_shareholders(self, async_client: AsyncOpenregister) -> None:
        async with async_client.company.with_streaming_response.retrieve_shareholders(
            "company_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    async def test_path_params_retrieve_shareholders(self, async_client: AsyncOpenregister) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `company_id` but received ''"):
            await async_client.company.with_raw_response.retrieve_shareholders(
                "",
            )

...
pip install git+ssh://git@github.com/joelrose/cap-sdks.git
```
...
These methods return an [`APIResponse`](https://github.com/joelrose/cap-sdks/tree/main/src/openregister/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/joelrose/cap-sdks/tree/main/src/openregister/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/joelrose/cap-sdks/issues) with questions, bugs, or suggestions.
